...
<nav class="navbar bg-body-tertiary">
    <form class="container-fluid justify-content-start">
        ...
        <a href="daftaranggota.php"></a>
        lihat kehadiran daftar hadir</button>
    </form>
</nav>
    ...
    <body background="image/latar2.jpg" style="background-size:cover;">
        ...
        <div class="container col-3">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" aria-describedby="namaHelp" name="nama" value="<?= $a['nama'] ?>">
        ...
        <div class="container col-3">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="NIS" aria-describedby="NISHelp" name="NIS" value="<?= $a['NIS'] ?>">
        ...
        <div class="container col-3">
            <div class="input-group">
                <select class="form-select" id="status" aria-label="Example select with button addon" name="keterangan_anggota" value="<?= $a['keterangan_anggota'] ?>">
        ...
        <div class="d-grid gap-2 col-1 mx-auto">
            <button type="submit" class="btn btn-secondary btn-lg" name="ganti">Add</button>
        </div>
    </body>
</form>
...
if (!isset($_POST['ganti'])){
    echo"silakan ubah/perbaiki";
    } else {
@$edit = $konek->query("UPDATE pengunjung SET nama='$_POST[nama]',NIS='$_POST[NIS]',keterangan_anggota='$_POST[keterangan_anggota]' WHERE No='$id'");

    echo"data berhasil diubah <a href=daftarpengunjung.php>kembali</a>";
}
?>
