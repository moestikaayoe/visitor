...
<nav class="navbar bg-body-tertiary">
    <form class="container-fluid justify-content-start">
        ...
        <a href="daftaranggota.php.php"></a>
...
@$edit = $konek->query("UPDATE anggota SET nama='$_POST[nama_lengkap]',tempat_lahir='$_POST[tempat_lahir]',email='$_POST[email]',tanggal_lahir='$_POST[tanggal_lahir]',jenis_kelamin='$_POST[jenis_kelamin]' WHERE No='$id'");

    echo"data berhasil diubah <a href=daftaranggota.php>kembali</a>";
}
?>